...
namespace WeatherForecast.Controllers
{
    public class HomeController : Controller
    {
        ...
        public String WeatherDetail(string City)
        {
            ...
            string appId = "87f2007a2250df1454ed786ed0ceb937";

            //API path with CITY parameter and other parameters.
            string url = string.Format("http://api.openweathermap.org/data/2.5/weather?q=Denver&appid=87f2007a2250df1454ed786ed0ceb937", City, appId);
